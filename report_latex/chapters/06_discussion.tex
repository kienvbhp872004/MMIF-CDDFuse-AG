...
\begin{enumerate}
    \item \textbf{Train data split không hoàn toàn paper-faithful}: paper không công bố cụ thể 286 cặp nào trong 810 cặp Harvard được dùng. Chúng tôi sample bằng seed 42 → khác paper composition $\to$ baseline reproduction lệch $\sim 10\text{--}20\%$.
    ...
    \item \textbf{Single seed (42)}: không đánh giá variance giữa các seed → cần $\geq 3$ seeds cho claim mạnh hơn.
\end{enumerate}
