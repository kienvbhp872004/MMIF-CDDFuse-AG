...
\begin{enumerate}
    \item Light retrain (10--25 epoch, freeze encoder/decoder) cho 4 alternatives Module~A và 4 alternatives Module~B $\to$ identify winners (Gated + Saliency).
...
\begin{itemize}
    ...
    \item Tuy nhiên, gain pooled toàn 3 modality chỉ 2/25 SIG $\to$ không thể claim ``Combined cải thiện CDDFuse'' theo nghĩa tổng quát.
